...
static
FRESULT dir_rewind (
	DIRECT *dj			/* Pointer to directory object */
)
{
	CLUST clst;
	FATFS *fs = FatFs;
...
static
FRESULT dir_find (
	DIRECT *dj,		/* Pointer to the directory object linked to the file name */
...
static
FRESULT dir_read (
	DIRECT *dj,		/* Pointer to the directory object to store read object name */
	BYTE *dir		/* 32-byte working buffer */
)
{
	FRESULT res;
...
static
FRESULT create_name (
	DIRECT *dj,			/* Pointer to the directory object */
...
FRESULT follow_path (	/* FR_OK(0): successful, !=0: error code */
	DIRECT *dj,			/* Directory object to return last directory and found object */
	BYTE *dir,			/* 32-byte working buffer */
